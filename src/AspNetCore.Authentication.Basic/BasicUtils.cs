...
namespace MadEyeMatt.AspNetCore.Authentication.Basic
{
	...
	internal static class BasicUtils
	{
		...
		///     If the <paramref name="claims" /> does not have claim of type <see cref="ClaimTypes.NameIdentifier" /> then
		///     username will be added as claim of type <see cref="ClaimTypes.NameIdentifier" />.
		///     If the <paramref name="claims" /> does not have claim of type <see cref="ClaimTypes.Name" /> then username will be
		///     added as claim of type <see cref="ClaimTypes.Name" />.
		/// </summary>
